Vue.component("eye-slash-fill-icon", {
    template: `
    <svg v-on:click="$emit('click', $event)" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-slash-fill" viewBox="0 0 16 16">
