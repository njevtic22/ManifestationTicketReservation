...
public class UpdateAdminCommand implements SelfValidating {
    public Long id;
    public String name;
    ...
    public UpdateAdminCommand(Long id, String name, String surname, String username, String dateOfBirth, String gender) {
        this.id = id;
        this.name = name;
