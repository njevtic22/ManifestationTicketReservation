...
public class AddSalesmanCommand implements SelfValidating {
    public String name;
    ...
    public AddSalesmanCommand(String name, String surname, String username, String password, String dateOfBirth, String gender) {
        this.name = name;
