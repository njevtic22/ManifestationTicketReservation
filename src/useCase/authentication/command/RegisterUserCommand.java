...
public class RegisterUserCommand implements SelfValidating {
    public String name;
    ...
    public RegisterUserCommand(String name, String surname, String username, String password, String dateOfBirth, String gender) {
        this.name = name;
